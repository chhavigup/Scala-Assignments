...
class Mroom2(Entry_time: String, Exit_time: String, Team: Boolean, Date: String, Group_Id: Int) {
  ...
  def checkAvailability(): String = {
    ...
    if (Team) {
      ...
      val query1 = s"SELECT * from mroom2 where Date='$Date' order By Entry_time Asc "
